...
{{< figure src="pr-overview.avif" caption="Update the version manually" >}}

So we have one single commit:

{{< figure src="pr-initial-commit.avif" caption="One single commit" >}}
...
{{< figure src="pr-commits.avif" caption="With the additional commit" >}}
...
{{< figure src="dependabot-enable.avif" caption="Enable Dependabot" >}}
...
{{< figure src="settings-add-pat.avif" caption="Create your Personal Access Token" >}}

Note the generated token and store it as a secret in the repository.

{{< figure src="secrets-add-pat.avif" caption="Add your new secret" >}}
