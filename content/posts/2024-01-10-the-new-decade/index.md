...
{{< figure src="snowcamp.avif" caption="SnowCamp 2023: <https://snowcamp.io/>" >}}
...
{{< figure src="campingdesspeakers.avif" caption="Deejay Workshop" >}}
...
{{< figure src="campingdesspeakers-elkie.avif" caption="Elkie with friends" >}}
...
{{< figure src="eah.avif" caption="Engineering All Hands in Orlando, FL, USA" >}}
...
{{< figure src="jugsummercamp.avif" caption="JUG Summer Camp 2023: <https://www.jugsummercamp.org/edition/14>" >}}
...
{{< figure src="devoxxma.avif" caption="Devoxx MA 2023: <https://devoxx.ma/>" >}}
...
{{< figure src="devoxxma-party.avif" caption="Devoxx MA 2023: <https://devoxx.ma/>" >}}
...
{{< figure src="training.avif" caption="Training in Paris" >}}

The story of "Elkie" is always a good one to share.

{{< figure src="training-elkie.avif" caption="Training in Paris" >}}
...
{{< figure src="utah2.avif" caption="Arches national park" >}}
...
PS: if you are curious, here are [some stats](stats.avif) about my 2023 year. It does not show everything but gives an idea.
