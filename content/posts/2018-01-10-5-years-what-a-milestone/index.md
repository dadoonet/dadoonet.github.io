...
{{< figure src="upgrade1.avif" caption="Choosing version 5.6.5" >}}
...
{{< figure src="upgrade2.avif" caption="Upgrade in progress" >}}

I just have to click one other button to upgrade Kibana as well to the right version.

{{< figure src="upgrade3.avif" caption="Upgrading Kibana" >}}

Just go to the Upgrade Assistant and apply what is recommended.

{{< figure src="upgrade4.avif" caption="Upgrade assistant" >}}

The reindex helper helps a lot doing that in one click.

{{< figure src="upgrade5.avif" caption="Reindex helper" >}}

And now I'm ready for the big jump!

{{< figure src="upgrade6.avif" caption="Choosing version 6.1.1" >}}

Et voilà!

{{< figure src="upgrade7.avif" caption="Ready for 6.1.1" >}}
...
{{< figure src="kibana1.avif" caption="Kibana read only mode" >}}

### 5 years of evangelism

Let's deep dive a bit now...

{{< figure src="kibana2-summary.avif" caption="Summary" >}}
...
{{< figure src="kibana2-events-km.avif" caption="Events and Kilometers" >}}
...
{{< figure src="kibana2-type.avif" caption="Type of event" >}}
...
{{< figure src="kibana2-attendees-and-type.avif" caption="Distribution of attendees per type of event" >}}
...
{{< figure src="kibana2-bbl-only.avif" caption="BBL only" >}}
...
{{< figure src="kibana2-bbl-location.avif" caption="BBL locations" >}}

This chart represents the farest countries I've been to and the number of events I attended there.

{{< figure src="kibana2-distance.avif" caption="Events by distance" >}}
...
{{< figure src="kibana3-2017-overview.avif" caption="Overview of 2017" >}}
...
{{< figure src="kibana3-2017.avif" caption="2017" >}}
...
{{< figure src="kibana3-2017-europe.avif" caption="2017 in Europe" >}}
