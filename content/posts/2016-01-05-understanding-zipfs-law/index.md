...
{{< figure src="chrome.avif" caption="Encoding" >}}
...
{{< figure src="all-terms.avif" caption="All french terms" >}}
...
{{< figure src="compassion.avif" caption="compassion* terms" >}}

I also looked at terms starting with `ch`. It gives:

{{< figure src="starts-with-ch.avif" caption="ch* terms" >}}
