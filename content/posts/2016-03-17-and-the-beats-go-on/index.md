...
{{< figure src="beats.avif" caption="Elastic Beats" >}}
...
{{< figure src="TheWhispers-AndTheBeatGoesOn.avif" caption="And the beat goes on" >}}
...
{{< figure src="kibana1.avif" caption="Select time range" >}}

Let's create a Timeseries visualization!

{{< figure src="kibana2.avif" caption="Timeseries visualization" >}}
...
{{< figure src="kibana3.avif" caption="Left waveform" >}}
...
{{< figure src="kibana4.avif" caption="With Right waveform" >}}
...
{{< figure src="kibana5.avif" caption="Final waveform" >}}
