...
Après avoir testé [Elasticsearch]({% post_url 2011-03-09-la-recherche-elastique %}), me voici parti pour regarder ce monde étrange qu'on appelle le [NoSQL](http://fr.wikipedia.org/wiki/Nosql)...
