...
{% img right /images/covers/elasticsearchfr.jpeg Elasticsearch FR user group %}
Mon objectif pour ce talk est de vous faire partager mon enthousiasme pour ce projet magnifique, de faire décoller la communauté française [@ElasticsearchFR](http://www.twitter.com/elasticsearchfr) et de susciter des engouements à utiliser, forker et contribuer !
...
{% img center /blog/images/devoxx2012/devoxxfr.png Devoxx France 2012 %}
