...
In the [previous post]({% post_url 2018-03-23-enriching-your-postal-addresses-with-elastic-stack-part-2 %}), we described how we can transform a postal address to a normalized one with also the geo location point or transform a geo location point to a postal address.
...
{% img /blog/images/bano3/ls-monitoring.png Logstash Monitoring %}

<center><i>Logstash Pipeline</i></center>

{% img /blog/images/bano3/ls-pipeline.png Monitoring the Logstash Pipeline %}

We can easily spot the bottleneck. 

<center><i>Elasticsearch Filter Plugin</i></center>

{% img /blog/images/bano3/ls-es-filter.png Elasticsearch Filter Plugin %}
