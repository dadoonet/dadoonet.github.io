...
{% img /blog/images/zipf/chrome.png Encoding %}
...
{% img /blog/images/zipf/all-terms.png All french terms %}
...
{% img /blog/images/zipf/compassion.png compassion* terms %}

I also looked at terms starting with `ch`. It gives:

{% img /blog/images/zipf/starts-with-ch.png ch* terms %}
