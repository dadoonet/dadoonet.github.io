...
We first need to create an elasticsearch client. We will use here a [Transport Client]({% post_url 2012-02-13-quel-client-java-pour-elasticsearch %}):
...
{% img /blog/images/devoxx2015/dashboard-crm.png CRM dashboard %}
...
{% img /blog/images/devoxx2015/dashboard-logs.png LOGS dashboard %}
...
{% img /blog/images/devoxx2015/Rocky_Mountain_Bull_Elk.jpg ELK %}
...
{% img /blog/images/devoxx2015/dashboard-twitter.png Twitter dashboard %}
