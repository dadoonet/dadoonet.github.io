...
{% img /blog/images/once-upon5/numbers.png Talks Trips in 2016 %}
...
If you never heard about Node Ingest, you can read the introduction of my article about [writing your own ingest plugin]({% post_url 2016-10-17-creating-an-ingest-plugin-for-elasticsearch-updated-for-ga %}).
...
{% img /blog/images/once-upon5/index-pattern.png Index Pattern %}

In Kibana, we can see some activity already over 2016:

{% img /blog/images/once-upon5/discover-2016.png Discover 2016 %}
...
{% img /blog/images/once-upon5/dashboard.png Dashboard %}

Neat, right?

My main activity is in Europe:

{% img /blog/images/once-upon5/europe.png Europe %}

And a big part of it is close to Paris:

{% img /blog/images/once-upon5/paris.png Paris %}
...
{% img /blog/images/once-upon5/discuss.png Discuss activity the last years %}

The other part is of course code, specifically on [elasticsearch](https://github.com/elastic/elasticsearch).

{% img /blog/images/once-upon5/github.png Git commits for elasticsearch in 2016 %}
...
{% img /blog/images/once-upon5/keep-calm.png Keep Calm %}
</div>
