...
Par défaut, on obtient ainsi un [TransportClient]({% post_url 2012-02-13-quel-client-java-pour-elasticsearch %}) qui se connecte automatiquement au noeud Elasticsearch tournant à l'adresse http://localhost:9200/.
