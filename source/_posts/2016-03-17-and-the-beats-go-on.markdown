...
comments: true
image: /images/covers/new/beats.png
categories: beats
---
...
<center>
{% img /blog/images/beats1/beats.png Elastic Beats %}
</center>
...
<center>
{% img /blog/images/beats1/TheWhispers-AndTheBeatGoesOn.png And the beat goes on %}
</center>
...
<center>
{% img /blog/images/beats1/kibana1.png Select time range %}
</center>

Let's create a Timeseries visualization!

<center>
{% img /blog/images/beats1/kibana2.png Timeseries visualization %}
</center>
...
<center>
{% img /blog/images/beats1/kibana3.png Left waveform %}
</center>
...
<center>
{% img /blog/images/beats1/kibana4.png With Right waveform %}
</center>
...
<center>
{% img /blog/images/beats1/kibana5.png Final waveform %}
</center>
