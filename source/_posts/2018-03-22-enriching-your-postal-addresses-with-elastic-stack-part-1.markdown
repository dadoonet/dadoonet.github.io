...
comments: true
image: /images/covers/new/logstash.png
...
Let's add our `csv-filter` plugin as we already saw in [Exploring Capitaine Train dataset]({% post_url 2015-04-28-exploring-capitaine-train-dataset %}):
...
<center><i>Distribution of Bano addresses by department number</i></center>

{% img /blog/images/bano1/bano-regions.png Distribution of Bano addresses by department number %}

<center><i>Map of Bano addresses for France Metropolitan</i></center>

{% img /blog/images/bano1/bano-fr.png Bano addresses in France Metropolitan %}

<center><i>Map of Bano addresses for some France Overseas Departments</i></center>

{% img /blog/images/bano1/bano-dom.png Bano addresses in DOM %}

<center><i>Map of Bano addresses near by La Rochelle</i></center>

{% img /blog/images/bano1/bano-lr.png Bano addresses near by La Rochelle %}

<center><i>Top cities (in number of known addresses)</i></center>

{% img /blog/images/bano1/bano-cities.png Top cities (in number of known addresses) %}
...
Have a look at the [next post]({% post_url 2018-03-23-enriching-your-postal-addresses-with-elastic-stack-part-2 %}) to see how you can now use that dataset to perform address correction and transformation.
