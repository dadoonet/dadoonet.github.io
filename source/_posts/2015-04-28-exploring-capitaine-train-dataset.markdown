...
<center><blockquote class="twitter-tweet"><p>Ouvrez, ouvrez, les données structurées. Capitaine Train libère les gares : <a href="https://t.co/y6DjWsbALF">https://t.co/y6DjWsbALF</a> <a href="https://twitter.com/hashtag/opendata?src=hash">#opendata</a></p>&mdash; Capitaine Train (@capitainetrain) <a href="https://twitter.com/capitainetrain/status/591184013034938368">2015/04/23</a></blockquote></center>
...
{% img /blog/images/elk-stations/settings-set-index.png Set index name %}

## Discover your data

If not already set, define in `discover` your `stations` index:

{% img /blog/images/elk-stations/discover-set-index.png Set index name %}

Then choose fields you want to display:

{% img /blog/images/elk-stations/discover-set-fields.png Set fields %}

And save your search:

{% img /blog/images/elk-stations/discover-save-search.png Save your search %}

## Visualize your data

Create a new visualization and choose `Pie chart`:

{% img /blog/images/elk-stations/visualize-pie-chart.png Create visualisation %}

Select your saved search:

{% img /blog/images/elk-stations/visualize-pie-choose-search.png Select saved search %}

Split the slices using `country.raw` field so you will display number of train stations broken per country code.

{% img /blog/images/elk-stations/visualize-pie-final.png Final Pie %}

Save your visualization and create a new `Pie chart` on `idtgv_is_enabled` field:

{% img /blog/images/elk-stations/visualize-pie-idtgv.png IDTGV stations %}


Save your visualization and create a new `Tile map`:

{% img /blog/images/elk-stations/visualize-tile.png Create visualization %}

Select a `Geohash` aggregation on `location` field and increase `Precision` to `4`:

{% img /blog/images/elk-stations/visualize-tile-final.png Tile map %}
...
{% img /blog/images/elk-stations/dashboard-add-vis.png Select visualizations %}

And your saved search:

{% img /blog/images/elk-stations/dashboard-add-search.png Add a saved search %}

Arrange your dashboard and play with it!

{% img /blog/images/elk-stations/dashboard-final-1.png The final dashboard %}
...
{% img /blog/images/elk-stations/dashboard-idtgv.png IDTGV stations in France %}
