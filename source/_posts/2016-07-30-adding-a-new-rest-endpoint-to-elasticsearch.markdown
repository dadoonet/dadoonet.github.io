...
With what we saw [in the previous article]({% post_url 2016-07-27-creating-a-plugin-for-elasticsearch-5-dot-0-using-maven %}), we now have a Plugin skeleton ready to host our REST endpoint code.
We also have seen [how to create real integration tests]({% post_url 2016-07-29-elasticsearch-real-integration-tests %}).
...
have seen [previously]({% post_url 2016-07-29-elasticsearch-real-integration-tests %}):
