...
layout: post
slug: mon-premier-plugin-elasticsearch-rss-river
...
En standard, il existe 4 rivières :
  ...
  * CouchDB qui permet d'indexer toutes les nouveautés d'une base CouchDB. Voir aussi [cet article à ce propos](http://dev.david.pilato.fr/?p=138).
...
[Que vais-je faire de tout ce temps ? Que sera ma vie ?](http://www.youtube.com/watch?v=OI9ZwtA6QOw&feature=related)
