...
**NOTE:** This article is an updated version of [Elasticsearch real integration tests]({% post_url 2016-07-29-elasticsearch-real-integration-tests %})
...
[elasticsearch-plugin] [================================================>] 99%   [=================================================] 100%   -> Installed ingest-bano
