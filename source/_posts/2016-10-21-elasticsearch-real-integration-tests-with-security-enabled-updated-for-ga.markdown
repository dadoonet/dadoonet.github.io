...
**NOTE:** This article is an updated version of [Elasticsearch real integration tests with security enabled]({% post_url 2016-08-03-elasticsearch-real-integration-tests-with-security-enabled %})

In a recent post we have seen [how to create real integration tests]({% post_url 2016-10-18-elasticsearch-real-integration-tests-updated-for-ga %}).
