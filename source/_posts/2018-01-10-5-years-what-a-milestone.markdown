...
* 2013: [Once upon a time...]({% post_url 2013-01-15-once-upon-a-time-dot-dot-dot %})
* 2014: [Once upon a time: a year later...]({% post_url 2014-01-10-once-upon-a-time-a-year-later-dot-dot-dot %})
* 2015: [Once upon a time: Make your dreams come true]({% post_url 2015-01-19-once-upon-a-time-make-your-dreams-come-true %})
* 2016: [3 years! Time flies!]({% post_url 2016-01-12-3-years-time-flies %})
* 2017: [4 years at elastic!]({% post_url 2017-01-10-4-years-at-elastic %})

Before speaking about what happened the last 5 years for me, let's modify a bit [the script I wrote last year]({% post_url 2017-01-10-4-years-at-elastic %}).
...
{% img /blog/images/once-upon6/upgrade1.png Choosing version 5.6.5 %}
...
{% img /blog/images/once-upon6/upgrade2.png Upgrade in progress %}

I just have to click one other button to upgrade Kibana as well to the right version.

{% img /blog/images/once-upon6/upgrade3.png Upgrading Kibana %}

Just go to the Upgrade Assistant and apply what is recommended.

{% img /blog/images/once-upon6/upgrade4.png Upgrade assistant %}

The reindex helper helps a lot doing that in one click.

{% img /blog/images/once-upon6/upgrade5.png Reindex helper %}

And now I'm ready for the big jump!

{% img /blog/images/once-upon6/upgrade6.png Choosing version 6.1.1 %}

Et voilà!

{% img /blog/images/once-upon6/upgrade7.png Ready for 6.1.1 %}
...
I [download the new version of filebeat](https://www.elastic.co/downloads/beats/filebeat) and 
change as well the filebeat configuration. I don't want to `cat` anymore my file but I'd like that filebeat process my CSV anytime I'm changing it or adding a new one in `/path/to/my/csv/files/`:
...
{% img /blog/images/once-upon6/kibana1.png Kibana read only mode %}

### 5 years of evangelism

Let's deep dive a bit now...

{% img /blog/images/once-upon6/kibana2-summary.png Summary %}
...
{% img /blog/images/once-upon6/kibana2-events-km.png Events and Kilometers %}
...
{% img /blog/images/once-upon6/kibana2-type.png Type of event %}
...
{% img /blog/images/once-upon6/kibana2-attendees-and-type.png Distribution of attendees per type of event %}
...
{% img /blog/images/once-upon6/kibana2-bbl-only.png BBL only %}
...
{% img /blog/images/once-upon6/kibana2-bbl-location.png BBL locations %}

This chart represents the farest countries I've been to and the number of events I attended there. 

{% img /blog/images/once-upon6/kibana2-distance.png Events by distance %}
...
{% img /blog/images/once-upon6/kibana3-2017-overview.png Overview of 2017 %}
...
{% img /blog/images/once-upon6/kibana3-2017.png 2017 %}
...
{% img /blog/images/once-upon6/kibana3-2017-europe.png 2017 in Europe %}
