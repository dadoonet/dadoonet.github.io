...
comments: true
image: /images/covers/found_logo.png
categories: 
- elasticsearch
- found
- logstash
...
Some months ago, I published a recipe on how to [index Twitter with Logstash and Elasticsearch]({% post_url 2015-06-01-indexing-twitter-with-logstash-and-elasticsearch %}).
...
{% img center /blog/images/found02/found_logo.png Found by elastic %}
...
{% img center /blog/images/found02/activate_kibana.png Activate Kibana 4 %}
...
Then I create an elasticsearch template file as explained in [my previous post]({% post_url 2015-06-01-indexing-twitter-with-logstash-and-elasticsearch %}):
...
<center><blockquote class="twitter-tweet" lang="fr"><p lang="en" dir="ltr">Don&#39;t forget our next <a href="https://twitter.com/ElasticFR">@ElasticFR</a> meetup! See you there guys! :D <a href="https://twitter.com/hashtag/elasticfr?src=hash">#elasticfr</a> <a href="https://t.co/SO2KxdEbv5">https://t.co/SO2KxdEbv5</a></p>&mdash; David Pilato (@dadoonet) <a href="https://twitter.com/dadoonet/status/666600269246038016">2015/11/17</a></blockquote></center>
...
{% img center /blog/images/found02/kibana_tweet.png Tweet is here %}
