...
In the [previous post]({% post_url 2018-03-22-enriching-your-postal-addresses-with-elastic-stack-part-1 %}), we described how we indexed data coming from the [BANO project](http://openstreetmap.fr/bano) so we now have indices containing all the french postal addresses.
...
Have a look at the [next post]({% post_url 2018-03-24-enriching-your-postal-addresses-with-elastic-stack-part-3 %}) to see how you can now use this technique to enrich your existing data.
