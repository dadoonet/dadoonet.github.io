...
{% img center /blog/images/legacy-search/beans.png Java Beans %}

Our database schema is quite similar.

{% img center /blog/images/legacy-search/tables.png Database tables %}
...
{% img /blog/images/legacy-search/00-inject.png Injecting 10 000 documents %}

[Home page](http://0.0.0.0:8080/#/) now gives you your 10 000 persons back.

{% img /blog/images/legacy-search/00-search-all.png Searching all %}

Note that you can search within `name`, `country` and `city` fields.

{% img /blog/images/legacy-search/00-search-jo.png Searching for jo %}
...
{% img /blog/images/legacy-search/00-search-advanced.png Searching for joe, england, plymouth %}
...
We are using here a `TransportClient` but you can use also a `NodeClient`. See [this article (french)]({% post_url 2012-02-13-quel-client-java-pour-elasticsearch %}).
...
{% img center /blog/images/legacy-search/02-marvel.png Marvel 10k documents %}
...
{% img center /blog/images/legacy-search/03-search-j.png Searching for J %}
...
{% img center /blog/images/legacy-search/04-faceted-1.png Faceted results %}
...
{% img center /blog/images/legacy-search/04-faceted-2.png Filtered results %}
...
{% img center /blog/images/legacy-search/05-compute.png Compute results %}
