...
{% img /blog/images/once-upon7/nyse.jpg NYSE %}
...
* January 2013: [Once upon a time...]({% post_url 2013-01-15-once-upon-a-time-dot-dot-dot %})
* January 2014: [Once upon a time: a year later...]({% post_url 2014-01-10-once-upon-a-time-a-year-later-dot-dot-dot %})
* January 2015: [Once upon a time: Make your dreams come true]({% post_url 2015-01-19-once-upon-a-time-make-your-dreams-come-true %})
* January 2016: [3 years! Time flies!]({% post_url 2016-01-12-3-years-time-flies %})
* January 2017: [4 years at elastic!]({% post_url 2017-01-10-4-years-at-elastic %})
* January 2018: [5 years. What a milestone!]({% post_url 2018-01-10-5-years-what-a-milestone %})

Before speaking about what happened last year, I'd like to modify [the way I'm ingesting my personal data in elasticsearch]({% post_url 2018-01-10-5-years-what-a-milestone %}) by using the real city name when I'm speaking in France. Why this? Because anytime I'm speaking in Paris or suburbs, I'm actually writing `Paris` in my report which is inaccurate.
...
* [Importing Bano dataset with Logstash]({% post_url 2018-03-22-enriching-your-postal-addresses-with-elastic-stack-part-1 %})
* [Using Logstash to lookup for addresses in Bano index]({% post_url 2018-03-23-enriching-your-postal-addresses-with-elastic-stack-part-2 %})
* [Using Logstash to enrich an existing dataset with Bano]({% post_url 2018-03-24-enriching-your-postal-addresses-with-elastic-stack-part-3 %})
...
{% img /blog/images/once-upon7/cloud.jpg Upgrade to 6.5.3 %}

## Importing Bano dataset

I just followed the instructions in [Importing Bano dataset with Logstash blog post]({% post_url 2018-03-22-enriching-your-postal-addresses-with-elastic-stack-part-1 %}) but I just modified the `elasticsearch` output to be:
...
We have seen in ["5 years. What a milestone!" blog post]({% post_url 2018-01-10-5-years-what-a-milestone %}) that we have now an index per year with documents looking like:
...
We have seen that in [Using Logstash to lookup for addresses in Bano index]({% post_url 2018-03-23-enriching-your-postal-addresses-with-elastic-stack-part-2 %}). Let's do it here.
...
{% img /blog/images/once-upon7/kibana-city-fix.jpg Fix cities %}

If we zoom a bit to `Paris`, we can see that actually Paris was Paris but also Saint-Cloud, Poissy...

{% img /blog/images/once-upon7/kibana-city-fix-paris.jpg Fix cities Paris %}
...
{% img /blog/images/once-upon7/kibana-city-fix-paris-2.jpg Fix cities Paris %}

Here is a list for cities in France which are not Paris:

{% img /blog/images/once-upon7/kibana-city-fix-paris-not.jpg Fix cities Not Paris %}

## Analyzing data

Let's have a final look at this 6th year of speaker activities...

{% img /blog/images/once-upon7/kibana-talks-distance.jpg Talks and distance %}
...
{% img /blog/images/once-upon7/kibana-where.jpg Where is the world %}
...
{% img /blog/images/once-upon7/kibana-countries-distance.jpg Distance and countries %}
...
{% img /blog/images/once-upon7/kibana-per-week.jpg Talks per week %}
